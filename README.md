...
---
## **💭** 후기
2인이서 다 해낼 수 있을까 걱정이 많았지만, 나의 팀원과 취향이 비슷해서 결정이 빠르고 기획 하는 동안 즐거웠다. <br>
소통도 잘 되고 역할 나누기도 깔끔하게 돼서 오히려 더 효율적으로 작업할 수 있었고,<br>
이번 프로젝트 덕분에 '인원이 적어도 충분히 좋은 결과를 낼 수 있다'는 걸 경험할 수 있었다.<br><br>
처음에 막막했던 PHP도 계속 다루다 보니 익숙해졌고, 전보다 더 **서버-DB 간 데이터 흐름**을 이해하게 되었다.<br> 
프론트엔드 개발자로서 백엔드 구조를 이해하는 게 왜 중요한지도 다시 한 번 느낀 프로젝트였다.
